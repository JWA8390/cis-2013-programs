...
var passwordCheckOld = function () 
{
    ...
    {
        stringOutput = ("The password much be at least 8 characters - - - please try again!");
    }
    else
    {
        for(counter = 0; counter <arrayBadPasswords.length; counter++)
        {
            if(stringPassword === arrayBadPasswords[counter])
            {
                stringOutput = ("Gurl . . . that's a bad password. Try again!");
                break;
            }
            else
            {
                stringOutput = ("Gurl . . . this is perfection!");
            }
        }
    }
